...
namespace TimeLogger.Wpf.ViewModels
{
    public class WelcomeViewModel : ObservableObject, IDataErrorInfo
    {
        ...
        private DateTime _initialiseTime;
        private string _timeLoggingTickets;

        public WelcomeViewModel()
        {
            Begin = new DelegateCommand(BeginAction);
            Initialise = new DelegateCommand(InitialiseAction);
            ...
            get
            {
                switch (columnName)
                {
                    ...
                    case "SleepDurationMins":
                        ...
                        return null;
                    case "StartTime":
                        if (StartTime.Date != _initialiseTime.Date)
        ...
        private void InitialiseAction(object arg)
        {
            if (!(arg is DateTime)) return;
            var time = (DateTime) arg;
            StartTime = time;
            _initialiseTime = time;
        }
